...
return [
    ...
    ['POST', '#^/admin/polls/([0-9a-f-]+)/participants/(\d+)/toggle-contact$#',    'admin_participants', 'route_admin_toggle_participant_contact'],
    ...
    ['POST', '#^/admin/polls/([0-9a-f-]+)/notifications/(\d+)/override$#','admin_notifications', 'route_admin_override_notification'],
